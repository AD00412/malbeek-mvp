/**
 * مجموعة أيقونات ملبّيك — خطية (stroke) متسقة، ترث اللون من المحيط.
...
const PATHS = {
  ...
  whatsapp: <><path d="M20 12a8 8 0 0 1-12 6.9L4 20l1.2-3.7A8 8 0 1 1 20 12z"/><path d="M9 9c0-.6.6-1 1.2-1H11c.5 1.2 1 1.8 1.5 2.5-.4.5-.8.9-1 1.2 1 1.4 2 2.4 3.4 3.4.3-.2.7-.6 1.2-1 .7.5 1.3 1 2.5 1.5v.8c0 .6-.4 1.2-1 1.2-3.6 0-8.6-5-8.6-8.6z"/></>,
