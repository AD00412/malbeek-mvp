...
const SHIPPED = [
  { ic: 'building', t: 'تعدّد الباصات للرحلة', d: 'أكثر من باصٍ في الرحلة الواحدة مع توزيعٍ تلقائيٍّ للمقاعد.' },
  { ic: 'chart', t: 'تحليلات الحملة', d: 'مؤشّرات الإشغال والإيرادات والحضور والاسترداد، وتصديرٌ ماليّ.' },
  { ic: 'qr', t: 'تحديثٌ حيٌّ للمقاعد', d: 'يرى الجميع تغيّر الحجوزات فورًا — حجز/تعديل/إلغاء.' },
  { ic: 'badge', t: 'فريق الحملة وصلاحيّاته', d: 'ادعُ مشرفين وموظّفين لحملتك بصلاحيّاتٍ منضبطة.' },
]

const NEXT = [
  { ic: 'badge', t: 'حفظ التذكرة في محفظة الجوال', d: 'إضافة التذكرة إلى Apple/Google Wallet (تتطلّب شهادات توقيع) — عند الإطلاق الرسميّ.', tag: 'لاحق' },
  { ic: 'payments', t: 'بوّابة دفعٍ مباشرة', d: 'دفعٌ إلكترونيٌّ فوريٌّ داخل المنصّة — بعد فترة التجربة.', tag: 'لاحق' },
]
