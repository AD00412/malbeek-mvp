 ...
 */
const RELEASE = '2026-06-seat-map'

const SHIPPED = [
  { ic: 'seat', t: 'خريطة الباص التفاعلية', d: '٤٩ مقعدًا (بلا السائق ومساعده) بترقيمٍ من اليمين لليسار، اختيارٌ حيٌّ بضغطةٍ واحدة.' },
  { ic: 'customers', t: 'سياسات خصوصية المقاعد', d: 'ذكور / إناث / يمين-يسار / أمام-خلف / عوائل وذكور — مع تلوينٍ تلقائيٍّ للمناطق.' },
  { ic: 'barcode', t: 'تذكرة الصعود بالباركود', d: 'تذكرةٌ أنيقةٌ لكل معتمر برمز QR، تُحفظ كصورةٍ أو تُطبع.' },
  { ic: 'qr', t: 'المسح الحي بالكاميرا', d: 'مسحٌ مباشرٌ للصعود/التسكين يحدّث الحضور فورًا.' },
]
