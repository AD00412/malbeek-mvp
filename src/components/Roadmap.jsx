 ...
 */
const RELEASE = '2026-06-bus-editor'

const SHIPPED = [
  { ic: 'bus', t: 'باصٌ واقعيٌّ + صفحة تعديل', d: 'شكلٌ واقعيٌّ بكابينة سائقٍ يسارًا وأبوابٍ يمينًا، وصفحةٌ مخصّصةٌ لضبط الصفوف والصفّ الخلفي.' },
  { ic: 'seat', t: 'تخطيطٌ قابلٌ للضبط', d: 'غيّر عدد الصفوف والمقاعد الخلفية لأي حجم باص — السعة تُحسب تلقائيًّا.' },
  { ic: 'customers', t: 'سياسات خصوصية المقاعد', d: 'ذكور / إناث / يمين-يسار / أمام-خلف / عوائل — بتلوينٍ تلقائيٍّ للمناطق.' },
  { ic: 'qr', t: 'الباركود والمسح الحي', d: 'تذكرةٌ برمز QR ومسحٌ مباشرٌ للصعود والتسكين.' },
]

const NEXT = [
  { ic: 'share', t: 'تدفّق حجز العميل', d: 'العميل يفتح الرابط، يملأ بياناته، ويرى الخريطة الحيّة للباص ليختار مقعده.', tag: 'التالي' },
