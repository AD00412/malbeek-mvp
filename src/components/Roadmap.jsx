 ...
 */
const RELEASE = '2026-06-feedback-realtime'

const SHIPPED = [
  { ic: 'message', t: 'تواصلٌ مباشرٌ مع الإدارة', d: 'زرٌّ عائمٌ في كل لوحة لإرسال شكوى/اقتراح/سؤال، ومتابعة ردّ الإدارة.' },
  { ic: 'payments', t: 'تأكيد الدفع من المشترك', d: 'يصل مرجع العملية، يراجعه المشترك ويؤكّد الدفع بضغطة.' },
  { ic: 'qr', t: 'تحديثٌ حيٌّ للمقاعد', d: 'يرى الجميع تغيّر الحجوزات فورًا — حجز/تعديل/إلغاء.' },
  { ic: 'trash', t: 'إلغاء حجزك بضغطة', d: 'العميل يلغي حجزه من تذاكره؛ يُفرَّغ المقعد فورًا للآخرين.' },
]
