 ...
 */
const RELEASE = '2026-06-official-manifest'

const SHIPPED = [
  { ic: 'manifest', t: 'الكشف الرسمي للباص', d: '٩ أعمدة بترويسة المؤسسة والطاقم، ختمٌ إلكترونيٌّ أو يدوي، وطباعة/حفظ PDF.' },
  { ic: 'customers', t: 'تعبئة بيانات المعتمرين', d: 'إضافة المعتمرين لكل رحلة مع المقعد ومكان الركوب والحالة، وبحثٌ فوري.' },
  { ic: 'bus', t: 'بيانات الباص والطاقم', d: 'رقم/لوحة الباص، السائق ومساعده، والمشرف — تظهر في الكشف.' },
  { ic: 'sparkle', t: 'شاشة إدارة الرحلة', d: 'كل رحلةٍ لها مركزٌ مستقلٌّ: معتمرون، طاقم، وكشفٌ رسمي.' },
]

const NEXT = [
  { ic: 'barcode', t: 'الباركود وتذكرة الصعود', d: 'باركود لكل معتمر، مسحٌ حيّ للحضور، وحفظٌ في محفظة الجوال.', tag: 'التالي' },
  { ic: 'share', t: 'تدفّق حجز العميل', d: 'العميل يملأ بياناته ويختار مقعده عبر الرابط مباشرةً.', tag: 'قريبًا' },
