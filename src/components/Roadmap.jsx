 ...
 */
const RELEASE = '2026-06-mobile-shell'

const SHIPPED = [
  { ic: 'sparkle', t: 'هيكل موبايل أوّلًا', d: 'شريطٌ سفليٌّ للتنقّل، رأسٌ بحالة الاتصال، تجربةٌ سلسةٌ على الجوال والكمبيوتر.' },
  { ic: 'dashboard', t: 'نظرة عامة مُعاد بناؤها', d: 'بطاقات إحصاء واضحة، إجراءاتٌ سريعةٌ بارزة، شعار البوصلة في القلب.' },
  { ic: 'trips', t: 'بطاقات الرحلات', d: 'بدل الجداول على الجوال — مع تصفيةٍ سريعةٍ وأشرطة إشغال.' },
  { ic: 'share', t: 'ورقة سفلية لرابط المشاركة', d: 'تجربةٌ موحّدةٌ للنشر بسرعةٍ مع المعتمرين.' },
]

const NEXT = [
  { ic: 'manifest', t: 'الكشف الرسمي للباص', d: '٩ أعمدة + ترويسة المؤسسة + ختمٌ إلكترونيٌّ/يدوي + PDF وطباعة.', tag: 'التالي' },
  { ic: 'customers', t: 'تعبئة بيانات المعتمرين', d: 'تسجيل المعتمر، اختيار المقعد، البحث والتصفية.', tag: 'قريبًا' },
  { ic: 'barcode', t: 'الباركود وتذكرة الصعود', d: 'مسحٌ حيّ، حفظٌ في محفظة الجوال.', tag: 'لاحق' },
  { ic: 'payments', t: 'الدفع وإثبات الحجز', d: 'ربطٌ مع متجرٍ خارجي ثم العودة لإرفاق الإيصال.', tag: 'لاحق' },
]
