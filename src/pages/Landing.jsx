  ...
  return (
    <div className="lp">
      ...
      <section className="lp-hero">
        ...
        <h1>حملتك كاملةً<br/>في تطبيقٍ واحد</h1>
        <p>سجّل المعتمرين، وزّع المقاعد، أصدِر الكشوف، وامسح التذاكر بالباركود. كلُّ أدوات حملتك في مكانٍ واحدٍ، بسلاسةٍ تليق برحلةٍ روحانيّة.</p>
        ...
        <div className="lp-hero-meta">
          ...
          <span><Icon name="check" size={14} /> رحلةٌ كاملةٌ مجانًا</span>
          <span><Icon name="check" size={14} /> عربيٌّ بالكامل</span>
        </div>
      </section>

      {/* ===== بوصلةُ القبلة — قسمٌ مستقلٌّ بحقّه ===== */}
      <section className="lp-section-qibla lp-section-alt" id="qibla">
        <span className="qibla-section-tag">هديّةٌ روحانيّةٌ في المنصّة</span>
        <h2 className="qibla-section-title">بوصلةُ القبلة، حيّةٌ على جوّالك</h2>
        <p className="qibla-section-desc">تعمل من حسّاسات جوّالك مباشرةً: اتجاهٌ دقيقٌ بالدرجات، ومسافةٌ فعليّةٌ إلى الكعبة، وإحداثيّاتُ موقعك. هديّةٌ من ملبّيك لكلّ معتمرٍ، بلا تطبيقٍ منفصل.</p>
        <QiblaCompass />
      </section>

      {/* ===== Features ===== */}
      <section id="features" className="lp-section">
        <span className="lp-sec-tag">المميّزات</span>
        <h2>كلُّ ما تحتاجه حملتك في منصّةٍ واحدة</h2>
        <div className="lp-feats">
          <Feature icon="customers" title="إدارةُ المعتمرين"
            body="استيرادٌ جماعيٌّ من ملفّ، وتعديلٌ سريعٌ، وبحثٌ فوريٌّ بالاسم أو الهويّة أو الجوال." />
          <Feature icon="seat" title="خريطةُ المقاعد"
            body="باصٌ ثلاثيُّ الأبعاد، واختيارٌ ذاتيٌّ للمعتمر، وسياسةُ جلوسٍ مرنةٌ تحترم الخصوصيّة." />
          ...
          <Feature icon="qr" title="باركودٌ ومسحٌ حيٌّ"
            body="تذكرةُ صعودٍ لكلّ معتمرٍ بباركود، ومسحٌ فوريٌّ بالكاميرا بلا طوابير." />
          <Feature icon="payments" title="إدارةُ الدفع"
            body="اربطها بمتجر زِد أو سلّة، أو أرفِق إثباتَ التحويل يدويًّا حسب طريقتك." />
          <Feature icon="customers" title="فِرَقُ العمل"
            body="ادعُ مشرفين وموظّفين بصلاحيّاتٍ منضبطة، وكلٌّ يرى ما يخصّه فقط." />
        </div>
      </section>
      ...
      <section id="how" className="lp-section lp-section-alt">
        ...
        <div className="lp-steps">
          <Step n="١" title="أنشئ حسابك"
            body="بريدٌ وكلمةُ مرورٍ فقط، بلا أوراقَ ولا مكالماتٍ ولا انتظار." />
          <Step n="٢" title="جهّز حملتك"
            body="ارفع شعارك، وأنشئ الرحلة، واضبط مقاعد الباص في دقائق." />
          <Step n="٣" title="شارك الرابط"
            body="رابطٌ قصيرٌ مخصَّصٌ لحملتك، يحجز المعتمر عبره ويصله الباركود فورًا." />
        </div>
      </section>
      ...
      <section className="lp-section">
        <div className="lp-trust">
          <div>
            <span className="lp-sec-tag">الأمان والخصوصيّة</span>
            <h2>بياناتُ كلّ حملةٍ معزولةٌ على مستوى القاعدة</h2>
            <p className="lp-lede">
              لا حملةَ ترى بيانات حملةٍ أخرى. عزلٌ مفروضٌ على مستوى قاعدة البيانات،
              وتشفيرٌ كاملٌ للنقل، ونسخٌ احتياطيٌّ يوميٌّ، وكلمةُ مرورٍ مشفَّرةٌ لا نراها أبدًا.
            </p>
            <ul className="lp-checks">
              <li><Icon name="check" size={15} /> عزلٌ بيانيٌّ بـ Postgres RLS مفروضٌ على مستوى قاعدة البيانات.</li>
              <li><Icon name="check" size={15} /> اتّصالٌ مشفَّرٌ بالكامل عبر HTTPS و TLS 1.3.</li>
              <li><Icon name="check" size={15} /> كلماتُ المرور مفوَّضةٌ لـ Supabase Auth، بلا تخزينٍ محليّ.</li>
          ...
          <aside className="lp-trust-card">
            ...
            <div>
              ...
              <p>رحلةٌ كاملةٌ بكلّ المميّزات. اختبر المنصّة مع معتمرين حقيقيّين قبل أن تقرّر.</p>
      ...
      <section id="faq" className="lp-section lp-section-alt">
        ...
        <div className="lp-faq">
          ...
          <FaqItem
            ...
            a="لا. عزلُ البيانات مفروضٌ على مستوى قاعدة البيانات، وحتّى عبر الـ API لا يستطيع أحدٌ تجاوزَ هذا الحدّ." />
          <FaqItem
            q="كيف يحجز المعتمر مقعدَه؟"
            a="تشارك رابطًا قصيرًا مخصَّصًا لحملتك، يفتحه المعتمر فيُسجّل بياناته مرّةً واحدةً، ويختار مقعده من خريطة الباص، ويصله الباركود فورًا." />
          <FaqItem
            q="هل يمكنني إضافة موظّفين ومشرفين؟"
            a="نعم. تستطيع دعوةَ مشرفين يديرون الرحلات وموظّفين يمسحون التذاكر ويُسكّنون، وكلُّ دورٍ بصلاحيّاتٍ منضبطةٍ لا يرى ما لا يخصّه." />
          <FaqItem
          ...
          <FaqItem
            ...
            a="نتواصل معك لاختيار باقةٍ تناسب حجم حملتك، ولا يُحذف شيءٌ من بياناتك، فتُكمل من حيث توقّفت." />
        </div>
      </section>
        ...
        >
          <div className="doc-modal">
            ...
            <p className="doc-note">
              للتحقّق الرسميّ: انسخ رقم الوثيقة بزرّ «نسخ»، ثمّ اضغط «تحقّق رسميًّا» لتفتح صفحةُ التحقّق في منصّة العمل الحرّ، فالصق الرقم في خانة الاستعلام واضغط بحث.
            </p>
